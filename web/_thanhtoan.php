...
if (strtoupper($_SERVER['REQUEST_METHOD']) !== 'POST') {
    ...
    if (isset($_POST['addressId'], $_POST['sp'], $_POST['userId'])) {
        $dh = new DonHang();
        $themDonHang = $dh->themDonHang($_POST);
        if ($themDonHang) {
            $db = new Database();
            ...
            <tbody><tr>
                ...
                <td style="padding-top:20px;padding-bottom:10px;padding-left:10px;padding-right:10px">
                    ...
                    <span style="color:#336e51">
                        24052454375
                        </span> của quý khách đang trong quá trình xử lý.<br>
                    </div>
                </td>
            </tr>
            <tr>
        ...
        <div class="p-4 rounded-md shadow-md md:mx-0 mx-6 border-2 <?php echo $themDonHang ? 'border-green-500' : 'border-red-500' ?>">
            <?php if (isset($themDonHang) && $themDonHang == true) : ?>
                ...
                <div class="flex items-center justify-center gap-3">
                    ...
                    <a href="donhang.php" class="cursor-pointer hover:bg-green-400 px-4 py-2 border  text-white bg-green-500 rounded-md">Đơn mua</a>
                </div>
            <?php else : ?>
                <div class="">
