...
$dsspmn = $db->selectNonParam("select TOP 5 sanpham.id, sanpham.ten, sanpham.gia, sanpham.gioitinh, sanpham.ngaytao, sanpham.DanhMuc_id, sanpham.KhuyenMai_id, sanpham.anhdaidien as hinhanh, khuyenmai.thoigian_kt, khuyenmai.phantram, donhang.sosaotb, donhang.luotban
from sanpham
...
select TOP 5 sanpham.id, sanpham.ten, sanpham.gia, sanpham.gioitinh, sanpham.ngaytao, sanpham.DanhMuc_id, sanpham.KhuyenMai_id, sanpham.anhdaidien as hinhanh, khuyenmai.thoigian_kt, khuyenmai.phantram, donhang.sosaotb, donhang.luotban
                from sanpham
                left JOIN khuyenmai on sanpham.KhuyenMai_id = khuyenmai.id
                INNER join (
                  select kichcosanpham.SanPham_id, avg(sosaotb) as sosaotb, sum(luotban) as luotban 
